...
public class Quest : ScriptableObject
{
    ...
    {
        public string Name;
        [TextArea(0,50)] public string Description;
        public Sprite Icon;
    }
...
public class QuestEditor: Editor
{
    ...
    [MenuItem("Assets/Meme Wars/New Quest", priority=0)]
    ...
    void OnEnable()
    {
        ...
        //queries all classes that inherit the QuestGoal class
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(toDelete != -1)
        {
            ...
            // need to do it twice, first time will nullify the entry, second time actually removes it. Idk man, I just work here.
