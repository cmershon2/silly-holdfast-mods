...
public class CustomPlayerScripts : MonoBehaviour
{
    ...
    public void getAllByLayer()
    {
        ...
        foreach(GameObject gameObj in GameObject.FindObjectsOfType<GameObject>())
        {
            ...
            if(gameObj.layer == playerLayerIndex && gameObj.GetComponent<PlayerPlatformMovement>() == null)
            {
    ...
    public void AddComponentToArray(List<GameObject> oldGameObjects)
    {
        ...
        {
            PlayerPlatformMovement newInstance = oldGameObjects[i].AddComponent<PlayerPlatformMovement>();
